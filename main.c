...
int main(int argc, char *argv[]) {
  ...
  /* Place window at bottom-right of main screen. Suits my development
   * environment/layout, can be changed as needed */
  ...
  while (running) {
    ...
    while (SDL_PollEvent(&event)) {
      ...
      case SDL_WINDOWEVENT:
        ...
        break;
      case SDL_KEYDOWN:
        _ki[event.key.keysym.scancode] = 1;
        break;
      case SDL_KEYUP:
        _ki[event.key.keysym.scancode] = 0;
        break;
      case SDL_MOUSEBUTTONDOWN:
        _mi[event.button.button] = 1;
        break;
      case SDL_MOUSEBUTTONUP:
        _mi[event.button.button] = 0;
        break;
    ...
    if (active) {
      ...
      /* Uncomment and remove the temp line to not quit when the window looses
       * focus */
      /* This is just intended as a quick way to quit when I'm done testing and
       * wish to return to coding quickly */
      /*SDL_Delay(100);*/
      running = 0; /* temp */
    }
...
int get_sw(void) { return _sw; }

int get_sh(void) { return _sh; }

float asp(void) { return _asp; }

byte ki(unshort k) { return _ki[k]; }
...
byte get_mm(void) { return _mm; }

float get_mx(void) { return _mx; }

float get_my(void) { return _my; }

float get_mw(void) { return _mw; }

float get_dt(void) { return _dt; }

void quit(void) { running = 0; }
